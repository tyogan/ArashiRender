...
public:
	UTILITY_API bool save(const std::string& file, bool flip = true) const;
	UTILITY_API bool load(const std::string& file, bool flip = true);
	UTILITY_API bool load(const char* buffer, size_t len, bool flip = true);
